...
export function cliUsage(): string {
  return [
    ...
    '  favorites --json              list model favorites',
    '  favorite capture H PROFILE --name NAME [--extract-credential] [--link-source]',
    '  favorite plan ID --harness H --connection ID [--profile NAME] [--activate]',
    '  favorite apply PLAN --request-id UUID --yes',
